    ...
    public class CurrencyRatesUsdProviderTests
    {
        ...
        public async Task GetRatesAsync_ReturnCorrectValues()
        {
            ...
            if(!responseIsNull)
            {
                ...
                var x = rates.Keys.Where(k => !_responseValues.ContainsKey(k));
